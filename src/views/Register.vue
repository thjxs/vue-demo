<template>
  <form class="form-signin" @submit.prevent="register">
    ...
    <div class="form-label-group">
      <input v-model="password_confirmation" id="inputPasswordConfirmation" type="password" class="form-control" placeholder="Password Confirmation" required>
      <label for="inputPasswordConfirmation">Password comfirmation</label>
    </div>
